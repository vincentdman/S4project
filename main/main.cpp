...
extern "C" void app_main(void)
{
   ...
   //PWM_GPIO a;
   LCD_Control a(GPIO_NUM_2,GPIO_NUM_32 ,GPIO_NUM_33,GPIO_NUM_25,GPIO_NUM_26,GPIO_NUM_4,GPIO_NUM_19,GPIO_NUM_21,GPIO_NUM_13,GPIO_NUM_27);

    std::string commands = "00111000";
